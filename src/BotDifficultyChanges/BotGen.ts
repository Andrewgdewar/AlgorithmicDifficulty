            ...
            if (cachedOfType.length > 0) {
                ...
                switch (true) {
                    ...
                    case BotGen.assaultTypes.includes(key.toLowerCase()):
                        const randomScav = globalValues.config.randomScavBrainChance > Math.random()
                        if (randomScav) {
                    ...
                    case BotGen.bearTypes.includes(key.toLowerCase()):
                        const chosenBear = BotGen.getRandom(globalValues.bearRoleList, level, globalValues.difficultyConfig.pmcDifficultyMaxLevel)
                        const randomBear = globalValues.config.randomPmcBrainChance > Math.random()
                    ...
                    case BotGen.usecTypes.includes(key.toLowerCase()):
                        const chosenUsec = BotGen.getRandom(globalValues.usecRoleList, level, globalValues.difficultyConfig.pmcDifficultyMaxLevel)
                        const randomUsec = globalValues.config.randomPmcBrainChance > Math.random()
                    ...
                    case BotGen.marksmanTypes.includes(key.toLowerCase()):
                        const randomMarksman = globalValues.config.randomMarksmanBrainChance > Math.random()
                        if (randomMarksman) {
